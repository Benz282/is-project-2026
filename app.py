...
# --- หน้าทดสอบโมเดล 1 (Ice) ---
    ...
    # --- เพิ่มตารางแสดงสถานะด้านล่างการทำนาย ---
        ...
        data_info = {
            ...
            "สถานะ (คำอธิบาย)": [
                "Gliding: ลื่นไถลไปข้างหน้าเฉยๆ แรงกระแทกต่ำ",
                "Push-off: เริ่มออกแรงถีบน้ำแข็ง (ค่า Accel พุ่งสูงขึ้น)",
                "Turning: กำลังเข้าโค้ง (ค่า Gyro และทิศทางเปลี่ยนเร็ว)",
        ...
        st.caption("🔍 หมายเหตุ: ค่า Accel และ Gyro เป็นค่าสมมติเพื่อประกอบการอธิบายลักษณะการเคลื่อนที่ตามช่วงเวลา (Timestamp)")
